...
export const mockEvent = {
  ...
  eventAdminFirstName: 'John',
  eventAdminLastName: 'Smith',
  eventAdminEmail: 'admin@techsummit2024.com',
  customAttributes: [],
  marketingAbbreviation: 'TECH2024',
  eventLogo: 'https://via.placeholder.com/40x40/4CAF50/FFFFFF?text=TS',
  fontFamily: 'Roboto',
  theme: 'Ocean Blue',
